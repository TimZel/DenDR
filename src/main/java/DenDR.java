...
public class DenDR {
        public static void main(String[] args) {
            String[] wordListOne = {"Генеральный", "Уважаемый", "Достопочтенный", "Непревзойденный", "Августейший"};
            String[] wordListTwo = {"Зять, ", "ДенГир, ", "Денис Анатольевич, ", "Отец моих племянников, ", "Фулстэк, ", "Мистер Д., "};
